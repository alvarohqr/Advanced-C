...
/*
  Write a program that will perform some arithmetic operation (user entry) on
  an array using function pointers
*/
...
int* performOp(int *a, int *b, int size, int (*fp)(int, int)) ;
